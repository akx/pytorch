...
class _UnionTag(str):
    ...
    def __eq__(self, cmp) -> bool:
        ...
        other = str(cmp)
        assert other in _get_field_names(self._cls), f"{other} is not a valid tag for {self._cls.__name__}. Available tags: {_get_field_names(self._cls)}"
...
class _Union:
    ...
    def create(cls, **kwargs):
        ...
        obj._type = _UnionTag.create(list(kwargs.keys())[0], cls)
        return obj
